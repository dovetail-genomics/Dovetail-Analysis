...
percent_cis = round(cis_reads*100.0/total_reads,2)
...
percent_trans = round(trans_reads*100.0/total_reads,2)
...
percent_cis_lt1kb = round(cis_lt1kb*100.0/total_reads,2)
percent_cis_gt1kb = round(cis_gt1kb*100.0/total_reads,2)
cis_gt1kb = format(cis_gt1kb,",d")
cis_lt1kb = format(cis_lt1kb,",d")
valid_read_pairs = int(output_dict["trans"]) + int(output_dict["cis_1kb+"])
percent_valid_read_pairs = round(valid_read_pairs*100.0/total_reads, 2)
...
percent_cis_gt10kb = round(cis_gt10kb*100.0/total_reads,2)
